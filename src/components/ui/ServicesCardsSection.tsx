    ...
    <section className="w-full py-10 bg-indigo-950/90 text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 table-lg:px-4">
        <div className="grid grid-cols-1 table-lg:grid-cols-2 gap-6 items-start">
          ...
          <div className="flex flex-col gap-6 self-start order-last table-lg:order-first">
            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-6 shadow-xl border border-white/20 table-lg:max-w-md w-full">
              <div className="flex flex-col items-center text-center gap-4 table-lg:flex-row table-lg:items-start table-lg:text-left">
                <div className="bg-blue-500/80 p-6 rounded-full flex-shrink-0">
            ...
            {/* Tarjeta mediana */}
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-6 shadow-xl border border-white/20 table-lg:max-w-lg w-full">
              <div className="flex flex-col items-center text-center gap-4 table-lg:flex-row table-lg:items-start table-lg:text-left">
                <div className="bg-blue-500/80 p-6 rounded-full flex-shrink-0">
          ...
          <div className="table-lg:pl-6 text-center table-lg:text-right order-first table-lg:order-last">
            <h2 className="text-5xl md-tablet:text-7xl font-extrabold text-white leading-tight mb-4">
              ¿En qué etapa se encuentra tu proyecto?
            </h2>
            <p className="text-2xl sm:text-xl text-gray-200 mb-8 max-w-xl mx-auto table-lg:mx-0">
