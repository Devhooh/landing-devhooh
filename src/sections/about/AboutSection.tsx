    ...
    <div className="bg-white py-16 px-4 md:px-8">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-gray-800 text-white rounded-2xl p-8 shadow-2xl max-w-5xl text-center">
            <h2 className="text-3xl table-lg:text-5xl font-extrabold mb-10">
        ...
        <div className="flex flex-col space-y-12 p-4">
          ...
          <div className="w-full table-lg:w-3/4 table-lg:self-start bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col table-lg:flex-row border border-gray-200">
            {/* Imagen de Visión - Tamaño reducido y centrado en móvil/tablet */}
            <div className="p-4 md-tablet:w-1/2 md-tablet:mx-auto table-lg:w-1/3 flex items-center justify-center bg-gray-100">
              <Image
                width={200}
                height={200}
          ...
          <div className="w-full table-lg:w-3/4 table-lg:self-end bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col table-lg:flex-row-reverse border border-gray-200">
