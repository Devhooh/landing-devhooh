...
//   return (
//     <section className="bg-gray-50 py-12 px-4 md-tablet:px-8">
//       <div className="max-w-5xl mx-auto text-center mb-12">
//         <h2 className="text-4xl table-lg:text-5xl font-extrabold text-blue-900">
...
//           <div
//             key={index}
//             className="flex items-center bg-white border border-gray-200 shadow-md rounded-xl p-6 hover:shadow-lg transition"
//           >
//             {/* Icono */}
