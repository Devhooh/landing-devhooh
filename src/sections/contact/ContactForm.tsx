...
export function ContactForm() {
  ...
  return (
    <motion.div
      className="w-full rounded-2xl border border-colorPrimario5 bg-colorPrimario6 text-white p-6 shadow-2xl"
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col">
          ...
          <textarea
            ...
            name="descripcion"
            rows={3}
            className="rounded-xl border border-gray-700 bg-white px-4 py-3 text-black
        ...
        <button
          type="submit"
          className="w-full py-4 font-semibold rounded-xl bg-colorPrimario1 border border-colorPrimario4
