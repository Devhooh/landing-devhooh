...
export function ContactForm() {
  ...
  return (
    <motion.div
      className="w-full rounded-2xl bg-gradient-to-b from-indigo-800 via-indigo-900 to-gray-950 text-white p-6 shadow-lg"
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <button
          type="submit"
          className="w-full py-4 font-semibold rounded-xl bg-gradient-to-r from-fuchsia-600 to-purple-600
          text-white shadow-md hover:scale-[1.02] hover:shadow-lg 
          transition-all duration-300"
        >
          Enviar mensaje
