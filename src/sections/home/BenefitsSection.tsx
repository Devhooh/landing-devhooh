    ...
    <section className="bg-gray-900 px-6 py-16 md-tablet:px-8 table-lg:px-32 relative">
      <div className="max-w-5xl mx-auto flex flex-col items-center gap-8">
        ...
        <div className="w-full flex justify-between table-lg:justify-around gap-4 md-tablet:gap-6">
          <div className={`w-32 h-32 md-tablet:w-52 md-tablet:h-52 rounded-full flex flex-col items-center justify-center p-4 ${styles.orangeCircle} bg-gradient-to-br from-fuchsia-500 to-purple-700 shadow-[0_0_20px_rgba(255,0,255,0.4)]`}>
          ...
          <div className={`w-32 h-32 md-tablet:w-52 md-tablet:h-52 rounded-full flex flex-col items-center justify-center p-4 ${styles.blueCircle} bg-gradient-to-br from-blue-500 to-indigo-700 shadow-[0_0_20px_rgba(0,255,255,0.3)]`}>
        ...
        {/* FILA INFERIOR DE CÍRCULOS */}
        <div className="w-full flex justify-between table-lg:justify-around gap-4 md-tablet:gap-6">
          <div className={`w-32 h-32 md-tablet:w-52 md-tablet:h-52 rounded-full flex flex-col items-center justify-center p-4 ${styles.redCircle} bg-gradient-to-br from-red-500 to-pink-600 shadow-[0_0_20px_rgba(255,0,0,0.4)]`}>
          ...
          <div className={`w-32 h-32 md-tablet:w-52 md-tablet:h-52 rounded-full flex flex-col items-center justify-center p-4 ${styles.greenCircle} bg-gradient-to-br from-green-400 to-teal-600 shadow-[0_0_20px_rgba(0,255,0,0.3)]`}>
