...
export function ProjectCard({
  ...
  return (
    <div className="bg-gray-900 rounded-3xl shadow-[0_0_20px_rgba(0,255,255,0.2)] overflow-hidden flex flex-col w-full transition-transform duration-300 hover:scale-[1.02] hover:shadow-[0_0_40px_rgba(0,255,255,0.4)]">
