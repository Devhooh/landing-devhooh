  ...
  return (
    <div className="bg-gray-100 border border-gray-500 rounded-xl shadow-sm hover:shadow-lg transition-shadow duration-300">
      ...
      >
        ...
        {isOpen ? <ChevronUp className="h-7 w-7 md-tablet:h-8 md-tablet:w-8 text-gray-500 shrink-0" /> : <ChevronDown className="h-7 w-7 md-tablet:h-8 md-tablet:w-8 text-gray-500 shrink-0" />}
      </button>
