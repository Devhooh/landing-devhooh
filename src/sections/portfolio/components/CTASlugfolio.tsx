    ...
    <div className="relative w-full h-auto my-32 flex justify-center overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center max-w-full">
          ...
          <p className="text-base tablet-md:text-xl font-bold text-slate-200 mb-4 pb-3">
            Podemos ayudarte a crear un software personalizado que conecte con tus clientes, haciendo que la atención de calidad este a solo un clic de distancia
          </p>
