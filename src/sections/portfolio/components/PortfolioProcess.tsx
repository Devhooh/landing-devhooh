    ...
    <section className="relative py-20 bg-white overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="relative p-6 rounded-3xl 
          ...
          <div className="grid gap-8 tablet-md:grid-cols-2 table-lg:grid-cols-3 justify-items-center">
            {project.process.map((proceso, index) => {
              ...
              return (
                <ProjectStaggerWrapper
                  ...
                  className={`
                    ...
                    transition-all duration-300 flex flex-col hover:scale-[1.02]
                  `}
                >
