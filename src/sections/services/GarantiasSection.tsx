...
//         {/* Bloque 2 */}
//         <div className="mt-20 bg-colorPrimario22 rounded-3xl shadow-xl p-10 flex flex-col items-center gap-12">
...
//                 text: "Si no cumple lo prometido, lo ajustamos hasta que estés conforme."
//               },
//               {
//                 icon: <Clock className="w-8 h-8 text-white" />,
//                 title: "Entrega puntual",
//                 text: "Compromiso firme en los tiempos pactados."
//               },
//               {
//                 icon: <Headphones className="w-8 h-8 text-white" />,
//                 title: "Soporte continuo",
//                 text: "Incluye soporte gratuito post-entrega (30-60 días)."
//               },
//               {
//                 icon: <TrendingUp className="w-8 h-8 text-white" />,
//                 title: "Escalabilidad asegurada",
//                 text: "Diseño y código listos para crecer junto a tu negocio."
//               }
//             ].map((item, i) => (
//               <motion.div
//                 key={i}
  ...
  return (
    <section className="relative w-full py-20 bg-colorFondo">
      <div className="container mx-auto px-6 tablet-md:px-12 max-w-7xl">
        ...
        {/* Bloque 2 */}
        <motion.div
          className="mt-20 bg-colorPrimario22 rounded-3xl shadow-xl p-10 flex flex-col items-center gap-12"
          initial="hidden"
          whileInView="show"
          viewport={{ once: true }}
          variants={{
