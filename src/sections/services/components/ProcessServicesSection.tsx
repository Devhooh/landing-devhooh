  ...
  return (
    <section className="py-12 px-6 md-tablet:px-12 bg-white">
      ...
      <div className="max-w-2xl mb-12">
        <h2 className="text-2xl md-tablet:text-4xl font-bold mb-4">Proceso de Desarrollo</h2>
      ...
      <div className="relative border-l-4 border-gray-400">
        {steps.map((step, index) => (
          <div key={index} className="mb-10 ml-16">
            {/* Número del timeline */}
            <div className="text-2xl absolute -left-5 flex items-center justify-center w-16 h-16 rounded-full bg-blue-600 text-white font-bold">
              {index + 1}
            </div>

            {/* Card del paso */}
            <div className="bg-gray-50 p-6 rounded-2xl shadow-md w-full md-tablet:w-[90%]">
