  ...
  const items = [
    {
      ...
      icon: <Layers className="w-8 h-8 text-fuchsia-600" />,
      description:
    ...
    },
    {
      ...
      icon: <Brain className="w-8 h-8 text-fuchsia-600" />,
      description:
    ...
    },
    {
      ...
      icon: <Smartphone className="w-8 h-8 text-fuchsia-600" />,
      description:
  ...
  return (
    <section className="py-5 px-4 table-lg:px-16">
      ...
      <motion.h2
        ...
        whileInView="show"
        viewport={{ once: true }}
        className="text-3xl table-lg:text-5xl font-extrabold text-center mb-12 text-blue-950"
      >
      ...
      >
        {items.map((item, index) => (
          <motion.div
            ...
            className="bg-fuchsia-100 border border-fuchsia-200 rounded-2xl shadow-md p-6 relative"
          >
            ...
            <p className="text-gray-600 text-left mt-2">{item.description}</p>
          </motion.div>
        ))}
      </motion.div>
    </section>
