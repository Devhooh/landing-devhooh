    ...
    <section className="w-full pb-5 pt-16 mx-auto">
      ...
      <div className="max-w-5xl mx-auto px-10 text-center items-center space-y-4">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-2xl md-tablet:text-3xl table-lg:text-4xl font-extrabold text-white pb-5"
        >
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-lg text-gray-300 md-tablet:text-xl max-w-3xl mx-auto"
        >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="overflow-hidden mt-12 py-5 mx-auto bg-colorSecundario4 border-y border-colorHover2"
      >
      ...
      <div className="overflow-hidden mx-auto mt-16 px-5 md-tablet:px-10 space-y-4 text-left">
        <motion.h3
          initial={{ x: -40, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          viewport={{ once: true }}
          className="text-2xl md-tablet:text-3xl font-bold text-white"
        >
        ...
        <motion.p
          ...
          transition={{ duration: 0.6, delay: 0.2 }}
          viewport={{ once: true }}
          className="text-lg md-tablet:text-xl max-w-2xl text-gray-300"
        >
